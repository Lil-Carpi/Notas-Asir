...
```
carpi@localhost:~$ sudo dnf install httpd mariadb-server php php-bcmath php-curl php-imagick php-intl php-json php-mbstring php-xml php-zip php-mysqli -y
```
...
![[Pasted image 20260511200159.png]]

![[Pasted image 20260511200311.png]]

![[Pasted image 20260511200415.png]]
